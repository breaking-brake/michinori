...
進捗の全体像を直感的に把握し、チームで共有しながら開発を進められる。

**Web版（デモ）** — ブラウザですぐ試せるデモ環境。インストール不要

**VSCode拡張（開発中）** — 開発環境と一体化し、日常的なプロジェクト計画に活用
...
- **AIと相談しながら調整** — チャットでDAGの修正を提案→プレビュー→承認の安全なフロー。AIがリポジトリのコードを調査し、タスクの完了状況を自律的に判断
